...
void loadImage(const char* pathname)
{
	...
	screenSize_X = bm.bmWidth;
	screenSize_Y = bm.bmHeight;
}
...
HWND createWindow(HINSTANCE inst)
{
	...
	return CreateWindow(TEXT("DisplayImage"), 0, (WS_BORDER), 0, 0, screenSize_X, screenSize_Y, NULL, NULL, inst, NULL);
...
{
	// load our image
	loadImage("C:\\Users\\Wilson Ow\\Desktop\\tiger.bmp");
